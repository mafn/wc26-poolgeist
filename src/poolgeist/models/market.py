"""User-provided market-prior adapter model."""
...
class MarketPriorModel:
    ...
    def predict_match(self, home_team: str, away_team: str) -> ModelSignal:
        ...
        return matrix_to_signal(
            ...
            home_team=home_team,
            away_team=away_team,
            explanations=["User-provided market-prior adapter model."],
            warnings=["Market model is neutral until user-provided odds are loaded."],
        )
